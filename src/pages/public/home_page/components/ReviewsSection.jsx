...
export default function ReviewsSection() {
  useEffect(() => {
    ...
    // Prevent duplicate script injections on re-renders
  ...
  return (
    <section aria-label="Google reviews" className="bg-black pt-16 ">
      <div className="w-[90%] md:w-[75%] mx-auto flex flex-col items-center">
        
        {/* Widget Container 
          'relative' allows absolute positioning for the mask inside it.
          'pb-8' creates space at the bottom so the widget content isn't cut off.
        */}
        <div className="relative w-full pb-8">
          
          <div 
            className="elfsight-app-a199dad3-906d-4693-a920-a569135893b3" 
            data-elfsight-app-lazy 
          />

          {/* THE BLACK COVER DIV (CSS MASKING)
            This div sits at the absolute bottom of the container.
            It uses the same background color (bg-black) as the section to seamlessly hide the watermark.
            'pointer-events-none' ensures it doesn't interfere with user interactions.
            'z-50' forces it to stay on top of the Elfsight badge.
          */}
          <div className="absolute bottom-0 left-0 w-full h-20 bg-black z-50 pointer-events-none"></div>
